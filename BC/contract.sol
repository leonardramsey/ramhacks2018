...
contract TrackFund is Ownable, StandardToken {
    ...
    function approveInstitute(string country, string instituteName, address NGOId) onlyOwner(){
     ...
     function approveIO(string country, string instituteName, address IOId) onlyOwner(){
    ...
    function transferFunds(address beneficiary, uint amount) onlyApprovedInstitute(msg.sender){
        transfer( beneficiary, amount);
    }
    
    //to check escrow Detail
    function checkNGODetail(address NGOId) constant returns(string, string, address, bool) {
    ...
    function checkIODetail(address IOId) constant returns(string, string, address, bool) {
